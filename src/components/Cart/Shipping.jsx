...
import {ShippingInfo} from "../../actions/cartActions"
        ...
        <div className="shippingContainer">
            <div className="shippingBox">
                ...
                <form className="shippingForm" onSubmit={shippingSubmit}>
                    ...
                    <div>
                        <PhoneIcon/>
                        <input type="number" placeholder='Phone Number' size={10} required value={phone} onChange={(e)=>setPhone(e.target.value)}/>
                    </div>
